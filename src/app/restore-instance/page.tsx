      ...
      <div className="mx-auto grid max-w-7xl gap-8">
        <header className="space-y-4 rounded-[32px] border border-white/70 bg-white/70 p-6 shadow-[0_30px_100px_-50px_rgba(12,34,64,0.35)] backdrop-blur-xl">
          ...
          <div>
            ...
            <p className="mt-3 max-w-3xl text-sm leading-7 text-slate-600">This stage provisions the Lightsail instance from the pinned snapshot and records the deployment details NewsClaw needs for the channel challenge.</p>
          </div>
        </header>
