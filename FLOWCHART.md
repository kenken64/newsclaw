...
flowchart TD
    ...
    J --> K{User action}
    K -- Edit topics --> G
    K -- Destroy instance --> L[Destroy + logout → /]
    K -- Sign out --> L2[Logout → /]
```
...
flowchart TD
    subgraph Signup
        ...
        S4 --> S5[Set session cookie → getPostAuthPath]
    end
    ...
    subgraph Signin
        ...
        L4 --> L5[Set session cookie → getPostAuthPath]
    end
...
flowchart TD
    ...
    B2 -- Completed --> B5[Redirect → /pair-channel]
    ...
    subgraph Background Worker
        ...
        W2 --> W3[Update job: running → completed]
    end
